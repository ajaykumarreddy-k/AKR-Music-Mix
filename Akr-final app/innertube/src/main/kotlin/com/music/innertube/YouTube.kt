...
object YouTube {
    ...
    suspend fun player(videoId: String, playlistId: String? = null, client: YouTubeClient = WEB_REMIX, signatureTimestamp: Int? = null, poToken: String? = null): Result<PlayerResponse> = runCatching {
