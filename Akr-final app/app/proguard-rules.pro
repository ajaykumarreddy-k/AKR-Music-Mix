...
-keepclassmembers class com.akr.finalapp.data.model.** { *; }
-keepclassmembers class com.akr.finalapp.domain.model.** { *; }

-keepattributes Signature, InnerClasses, EnclosingMethod, AnnotationDefault, *Annotation*

# Cast framework classes loaded via manifest/reflective entry points.
-keep class com.akr.finalapp.data.service.cast.CastOptionsProvider { *; }
...
-keep class com.akr.finalapp.data.preferences.PreferenceBackupEntry { *; }
-keep class com.akr.finalapp.data.backup.model.** { *; }
-keep class com.akr.finalapp.data.backup.module.** { *; }
# Backup payload entities are part of the persisted .pxpl contract.
-keep class com.akr.finalapp.data.database.FavoritesEntity { *; }
-keep class com.akr.finalapp.data.database.SongEngagementEntity { *; }
-keep class com.akr.finalapp.data.database.LyricsEntity { *; }
-keep class com.akr.finalapp.data.database.SearchHistoryEntity { *; }
-keep class com.akr.finalapp.data.database.TransitionRuleEntity { *; }
...
-keep class com.akr.finalapp.data.telegram.TelegramStreamProxy { *; }
