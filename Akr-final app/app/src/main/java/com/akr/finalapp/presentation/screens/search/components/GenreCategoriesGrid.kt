...
import com.akr.finalapp.presentation.components.getNavigationBarHeight
import com.akr.finalapp.presentation.components.resolveNavBarOccupiedHeight
import com.akr.finalapp.presentation.utils.GenreIconProvider
...
private fun GenreCard(
    ...
    val themeColor = remember(genre, isDark) {
        com.akr.finalapp.ui.theme.GenreThemeUtils.getGenreThemeColor(
            genre = genre,
            isDark = isDark,
