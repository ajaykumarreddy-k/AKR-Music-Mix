package com.akr.finalapp.data.service
...
import com.akr.finalapp.PixelPlayApplication
import com.akr.finalapp.MainActivity
import com.akr.finalapp.R
import com.akr.finalapp.data.diagnostics.PerformanceMetrics
import com.akr.finalapp.data.model.PlayerInfo
import com.akr.finalapp.data.model.PlaybackQueueItemSnapshot
import com.akr.finalapp.data.model.PlaybackQueueSnapshot
import com.akr.finalapp.data.preferences.EqualizerPreferencesRepository
...
import com.akr.finalapp.data.service.player.TransitionController
import com.akr.finalapp.ui.glancewidget.PlayerActions
import com.akr.finalapp.utils.AlbumArtUtils
...
import com.akr.finalapp.data.equalizer.EqualizerManager
import com.akr.finalapp.data.model.WidgetThemeColors
import com.akr.finalapp.data.preferences.AlbumArtColorAccuracy
import com.akr.finalapp.data.preferences.AlbumArtPaletteStyle
import com.akr.finalapp.presentation.viewmodel.ColorSchemeProcessor
import androidx.compose.ui.graphics.toArgb
import androidx.compose.material3.dynamicDarkColorScheme
import androidx.compose.material3.dynamicLightColorScheme
import com.akr.finalapp.data.preferences.ThemePreference
import com.akr.finalapp.data.service.auto.AutoMediaBrowseTree
import com.akr.finalapp.data.service.wear.buildWearThemePalette
import com.akr.finalapp.data.service.wear.WearStatePublisher
import com.akr.finalapp.presentation.viewmodel.ColorSchemePair
import com.akr.finalapp.shared.WearIntents
import com.akr.finalapp.utils.ArtworkTransportSanitizer
import com.akr.finalapp.utils.MediaItemBuilder
import com.akr.finalapp.data.navidrome.NavidromeRepository
import com.akr.finalapp.di.AppScope
import com.akr.finalapp.presentation.viewmodel.ListeningStatsTracker
...
class MusicService : MediaLibraryService() {
    ...
    @Inject
    lateinit var replayGainManager: com.akr.finalapp.data.media.ReplayGainManager
    @Inject
    ...
    companion object {
        ...
        const val ACTION_SLEEP_TIMER_EXPIRED = "com.akr.finalapp.ACTION_SLEEP_TIMER_EXPIRED"
        const val EXTRA_FORCE_FOREGROUND_ON_START =
            "com.akr.finalapp.extra.FORCE_FOREGROUND_ON_START"
        ...
        private const val APP_PACKAGE_PREFIX = "com.akr.finalapp"
    ...
    private suspend fun buildPlayerInfo(): PlayerInfo {
        ...
        val queueItems = mutableListOf<com.akr.finalapp.data.model.QueueItem>()
        ...
        if (!snapshotTimeline.isEmpty) {
            ...
            for (i in startIndex until endIndex) {
                ...
                if (songId != null) {
                    ...
                    queueItems.add(
                        com.akr.finalapp.data.model.QueueItem(
                            id = songId,
    ...
    private suspend fun resolveWearLyrics(mediaId: String?): com.akr.finalapp.data.model.Lyrics? {
    ...
    public suspend fun loadArtworkBytesForWidget(uri: Uri): ByteArray? {
        ...
        val isLocalArtworkUri = com.akr.finalapp.utils.LocalArtworkUri.isLocalArtworkUri(uriString)
        return when {
