...
import com.akr.finalapp.presentation.screens.WordDelimiterConfigScreen
...
import com.akr.finalapp.data.preferences.LaunchTab
import com.akr.finalapp.data.preferences.UserPreferencesRepository
import com.akr.finalapp.presentation.screens.AlbumDetailScreen
import com.akr.finalapp.presentation.screens.AccountsScreen
import com.akr.finalapp.presentation.screens.ArtistDetailScreen
import com.akr.finalapp.presentation.screens.ArtistSettingsScreen
import com.akr.finalapp.presentation.screens.DailyMixScreen
import com.akr.finalapp.presentation.screens.EditTransitionScreen
import com.akr.finalapp.presentation.screens.EasterEggScreen
import com.akr.finalapp.presentation.screens.ExperimentalSettingsScreen
import com.akr.finalapp.presentation.screens.GenreDetailScreen
import com.akr.finalapp.presentation.screens.HomeScreen
import com.akr.finalapp.presentation.screens.LibraryScreen
import com.akr.finalapp.presentation.screens.MashupScreen
import com.akr.finalapp.presentation.screens.NavBarCornerRadiusScreen
import com.akr.finalapp.presentation.screens.PaletteStyleSettingsScreen
import com.akr.finalapp.presentation.screens.PlaylistDetailScreen
import com.akr.finalapp.presentation.screens.RecentlyPlayedScreen

import com.akr.finalapp.presentation.screens.AboutScreen
import com.akr.finalapp.presentation.screens.SearchScreen
import com.akr.finalapp.presentation.screens.StatsScreen
import com.akr.finalapp.presentation.screens.SettingsScreen
import com.akr.finalapp.presentation.screens.SettingsCategoryScreen
import com.akr.finalapp.presentation.screens.EqualizerScreen
import com.akr.finalapp.presentation.screens.YoutubeSearchScreen
import com.akr.finalapp.presentation.screens.YoutubePlaylistScreen
...
import com.akr.finalapp.presentation.components.ScreenWrapper
...
fun AppNavigation(
    ...
    startDestination?.let { initialRoute ->
        NavHost(
            ...
            composable(
                route = Screen.YoutubePlaylist.route,
            ...
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel) {
                    com.akr.finalapp.presentation.screens.DeviceCapabilitiesScreen(
                        navController = navController,
                        playerViewModel = playerViewModel
                    )
                }
            ...
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel) {
                    com.akr.finalapp.presentation.netease.dashboard.NeteaseDashboardScreen(
            ...
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel) {
                    com.akr.finalapp.presentation.qqmusic.dashboard.QqMusicDashboardScreen(
                        onBack = { navController.popBackStack() }
                    )
                }
            }
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel) {
                    com.akr.finalapp.presentation.navidrome.dashboard.NavidromeDashboardScreen(
                        onBack = { navController.popBackStack() }
                    )
                }
            }
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel) {
                    com.akr.finalapp.presentation.jellyfin.dashboard.JellyfinDashboardScreen(
                        onBack = { navController.popBackStack() }
                    )
                }
            }
