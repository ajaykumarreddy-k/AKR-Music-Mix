...
import com.akr.finalapp.utils.AlbumArtCacheManager
...
import com.akr.finalapp.utils.MediaMetadataRetrieverPool
...
class PixelPlayApplication : Application(), ImageLoaderFactory, Configuration.Provider {
    ...
    @Inject
    lateinit var telegramCoilFetcherFactory: dagger.Lazy<com.akr.finalapp.data.image.TelegramCoilFetcher.Factory>

    @Inject
    lateinit var navidromeCoilFetcherFactory: dagger.Lazy<com.akr.finalapp.data.image.NavidromeCoilFetcher.Factory>

    @Inject
    lateinit var jellyfinCoilFetcherFactory: dagger.Lazy<com.akr.finalapp.data.image.JellyfinCoilFetcher.Factory>

    @Inject
    lateinit var localArtworkCoilFetcherFactory: dagger.Lazy<com.akr.finalapp.data.image.LocalArtworkCoilFetcher.Factory>
